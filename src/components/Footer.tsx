    ...
    return (
        <FooterContainer>
            <FooterButtons>
                ...
                <StyledLink to="/chatlist" isCurrentPage={location.pathname === '/chatlist'}>
                    <MdChat/>
                </StyledLink>
                <StyledLink to="/timeline" isCurrentPage={location.pathname === '/timeline'}>
                    <IoMdSchool />
                </StyledLink>
                <StyledLink to="/profile" isCurrentPage={location.pathname === '/profile'}>
                    <BsPersonFill />
                </StyledLink>
            </FooterButtons>
        </FooterContainer>
